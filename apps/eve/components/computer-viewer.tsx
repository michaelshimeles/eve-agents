...
//
// noVNC connects to whatever websocket /api/computer hands back: Orgo's own
// websockify endpoint on localhost (an origin Orgo admits), the same-origin
// relay at /api/computer/ws everywhere else (Orgo cuts unknown browser
// origins off with "Origin not allowed"). The password rides along for VNC's
// in-band auth and is scoped to this one desktop.

 ...
 */
function imessageAppResponse(request: NextRequest): NextResponse {
...
export default clerkMiddleware((_auth, request) => {
  ...
  if (pathname === "/imessage/apps" || pathname.startsWith("/imessage/apps/")) {
    return imessageAppResponse(request);
  }
